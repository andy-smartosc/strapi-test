...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    word_collections: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
...
export interface ApiExampleExample extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::example.example', 'sentence'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiToiecTopicToiecTopic extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::toiec-topic.toiec-topic', 'name'>;
    isCharging: Attribute.Boolean;
    imageLink: Attribute.String;
    words: Attribute.Relation<
      'api::toiec-topic.toiec-topic',
      'oneToMany',
      'api::word.word'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiWordWord extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::word.word', 'name'>;
    description: Attribute.String;
...
export interface ApiWordCollectionWordCollection extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::word-collection.word-collection', 'name'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::toiec-topic.toiec-topic': ApiToiecTopicToiecTopic;
